...
namespace ITIManagement.DAL.Migrations
{
    ...
    [Migration("20250823134310_initialwithSeedingData")]
    partial class initialwithSeedingData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Course", b =>
                {
                    b.HasOne("ITIManagement.DAL.Models.User", "Instructor")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Grade", b =>
                {
                    b.HasOne("ITIManagement.DAL.Models.Session", "Session")
                        .WithMany("Grades")
                        .HasForeignKey("SessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ITIManagement.DAL.Models.User", "Trainee")
                        .WithMany("Grades")
            ...
            modelBuilder.Entity("ITIManagement.DAL.Models.Session", b =>
                {
                    b.HasOne("ITIManagement.DAL.Models.Course", "Course")
                        .WithMany("Sessions")
